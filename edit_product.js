...
var clothesdesign = document.getElementById("clothesdesign")
var price = document.getElementById("price")
var qty = document.getElementById("qty")
var img = ""

firebase.database().ref("clothes/").child(id).once("value", (snap) => {
    console.log(snap.toJSON())
    var data = snap.toJSON()
    clothesdesign.value = data[""]
...
submit1 = async () => {
  await   firebase.database().ref("clothes/").child(id).update(
        {
            clothes_design: clothesdesign.value,
            Price:price.value,
            Qty:qty.value,
