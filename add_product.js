...
var dishname = document.getElementById("clothesdesign")
...
async function submit1(){
    event.preventDefault()
    var key = firebase.database().ref("clothes").push().getKey()
   ...
   await  firebase.database().ref("clothes").child(key.toString()).set(obj)
